...
{id:'deepscope',name:'Deep Scope',fixed:'https://deepscope-research.cwhit.chatgpt.site/'}
];
window.CalculatorProjectLinks=Object.fromEntries(PROJECTS.filter(p=>p.fixed).map(p=>[p.id,p.fixed]));
